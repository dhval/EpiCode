...
public class MaxSubmatrixSquare {
    ...
    private static int check_ans(ArrayList<ArrayList<Boolean>> A) {
        int max = 0;
    ...
    public static int max_square_submatrix(ArrayList<ArrayList<Boolean>> A) {
    ...
    public static void main(String[] args) {
        ...
        for (int times = 0; times < 1000; ++times) {
            ...
            System.out.println(max_square_submatrix(A));
