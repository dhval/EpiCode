...
import static com.drx.epi.Sudoku_check.is_valid_Sudoku;
import static com.drx.epi.utils.Utils.simplePrint;
import static java.lang.Math.sqrt;

public class Sudoku_solve {
	// @include
	public static boolean valid_to_add(int[][] A, int i, int j, int val) {
		...
		int region_size = (int) sqrt(A.length);
	...
	public static boolean solve_Sudoku_helper(int[][] A, int i, int j) {
		if (i == A.length) {
